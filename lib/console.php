...
class Console
{
     ...
     * @return bool
     */
    public function commandSchema(): bool
    {
    ...
    {
        $stopOnErrors = $this->versionConfig->getValBool('stop_on_errors');
    ...
    protected function initializeArgs($args): string
    {
        foreach ($args as $val) {
            $this->addArg($val);
        }
    ...
    {
        if ($this->versionConfig->getValBool('console_auth_events_disable')) {
